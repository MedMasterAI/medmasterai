...
export async function generarHTMLMedMaster(esquema) {
    ...
    if (!fallbackText)
        throw new Error(`No se recibió texto de fallback ${MODEL_GEMINI_1_5}`);
    return fallbackText.trim();
}
//# sourceMappingURL=generarHTMLMedMaster.js.map