...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background text-foreground transition-colors duration-300 px-4 py-12">
      <Image src="/322.png" alt="Fondo decorativo" fill className="absolute inset-0 object-cover opacity-30 z-0" />
      <div className="z-10 w-full max-w-md space-y-6 rounded-xl bg-card/80 p-8 shadow-xl backdrop-blur-lg">
        <div className="flex flex-col items-center gap-4">
          ...
          <h1 className="text-2xl font-semibold text-center text-foreground">Recuperar contraseña</h1>
          <p className="text-sm text-muted-foreground text-center">Ingresa tu email para recibir un enlace de recuperación.</p>
        </div>
